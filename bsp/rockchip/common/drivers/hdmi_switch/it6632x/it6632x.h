...
#define IT6632X_ISP_SECTOR_SIZE 1024UL
#define IT6632X_ISP_SECTOR_COUNT 128
#define IT6632X_ISP_MAX_CODE_SIZE (IT6632X_ISP_SECTOR_COUNT*IT6632X_ISP_SECTOR_SIZE)
#define IT6632X_CE_DONE 0x80
#define IT6632X_CE_FAIL 0x40
#define IT6632X_SE_DONE 0x40
#define IT6632X_SE_FAIL 0x20
...
typedef struct
{
    rt_uint8_t use_sector_erase;
    int enter_isp_retry;
    int data_verify_retry;
    rt_uint8_t isp_state;
    rt_uint8_t erase_map[IT6632X_ISP_SECTOR_COUNT];
    rt_uint8_t *fw_code;
    rt_uint32_t fw_length;
    rt_uint32_t fw_length_align;
    int fw_sector_count;

} ISP_CTX;
#define __ALIGN_MASK(x,mask)    (((x)+(mask))&~(mask))
#define ALIGN_UP_u32(x, a)  __ALIGN_MASK(x,(rt_uint32_t)(a)-1)

#define IT6632X_FW_PATH "/data/it6632x_fw.bin"
