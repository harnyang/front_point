...
#ifdef RT_USING_PWM0
    GIC_AMP_IRQ_CFG_ROUTE(PWM0_IRQn, 0xd0, CPU_GET_AFFINITY(3, 0)),
#endif
    // GIC_AMP_IRQ_CFG_ROUTE(GPIO1_IRQn, 0xd0, CPU_GET_AFFINITY(3, 0)),//gpio1sda scl的打印
    // GIC_AMP_IRQ_CFG_ROUTE(GPIO4_IRQn, 0xd0, CPU_GET_AFFINITY(3, 0)),
