...
static struct GIC_AMP_IRQ_INIT_CFG irqsConfig[] =
{
    ...
    /* TODO: By default, UART0 is used for master core CPU0, and UART5 is used for remote core CPU3 */
#ifdef RT_USING_UART0
    GIC_AMP_IRQ_CFG_ROUTE(UART0_IRQn, 0xd0, CPU_GET_AFFINITY(0, 0)),
#endif
    ...
    GIC_AMP_IRQ_CFG_ROUTE(GPIO0_EXP1_IRQn, 0xd0, CPU_GET_AFFINITY(3, 0)),
    GIC_AMP_IRQ_CFG_ROUTE(GPIO1_EXP1_IRQn, 0xd0, CPU_GET_AFFINITY(3, 0)),
    GIC_AMP_IRQ_CFG_ROUTE(GPIO2_EXP1_IRQn, 0xd0, CPU_GET_AFFINITY(3, 0)),
    GIC_AMP_IRQ_CFG_ROUTE(GPIO3_EXP1_IRQn, 0xd0, CPU_GET_AFFINITY(3, 0)),
    GIC_AMP_IRQ_CFG_ROUTE(GPIO4_EXP1_IRQn, 0xd0, CPU_GET_AFFINITY(3, 0)),
#endif
#endif
