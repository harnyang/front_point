...
typedef struct
{
    ...
    rt_uint8_t init;
    rt_uint8_t chip_mode;            //0:normal mode 1:isp_mode
...
#define EP_DISMATCH   (0)
#define EP_91A7P      (1)

#define EP91A7P_VENDOR_ID_0           (0x17)
#define EP91A7P_VENDOR_ID_1           (0x7A)
#define EP91A7P_DEVICE_ID_0           (0x91)
#define EP91A7P_DEVICE_ID_1           (0xA7)
