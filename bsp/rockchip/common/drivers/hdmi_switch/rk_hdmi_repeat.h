...
#define RK_REPEAT_ISP_UNSUPPORT       (-1)
#define RK_REPEAT_ISP_FW_NOT_FOUND    (-2)
#define RK_REPEAT_ISP_BAD_FW          (-3)
#define RK_REPEAT_ISP_NO_NEED_UPDATE  (-4)
#define RK_REPEAT_ISP_UPDATE_FAILED   (-5)
